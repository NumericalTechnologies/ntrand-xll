...
- 2つのパラメータ $\alpha, \beta$ が必要です ([どうやって求めるの？](https://www.ntrand.com/jp/ntbetaparam/))
...
- [累積分布関数](https://www.ntrand.com/jp/glossary/#local_cumulative)
  ...
  ここで $I_x(\cdot,\cdot)$ は [正規化された不完全ベータ関数](https://www.ntrand.com/jp/glossary/#local_Regularized_incomplete_beta)です。
...
- 関連 NtRand 関数 : [NTBETADIST](https://www.ntrand.com/jp/ntbetadist/)
...
- 関連 NtRand 関数 : [NTBETAMEAN](https://www.ntrand.com/jp/ntbetamean/)
...
- 関連 NtRand 関数 : [NTBETASTDEV](https://www.ntrand.com/jp/ntbetastdev/)
...
- 関連 NtRand 関数 : [NTBETASKEW](https://www.ntrand.com/jp/ntbetaskew/)
...
- 関連 NtRand 関数 : [NTBETAKURT](https://www.ntrand.com/jp/ntbetakurt/)
...
- 関連 NtRand 関数 : [NTRANDBETA](https://www.ntrand.com/jp/ntrandbeta/)
...
- 既に分布のパラメータをお持ちの場合
  - Mersenne Twiseter 法による乱数生成 : [NTRANDBETA](https://www.ntrand.com/jp/ntrandbeta/)
  - 確率計算 : [NTBETADIST](https://www.ntrand.com/jp/ntbetadist/)
  - 平均計算 : [NTBETAMEAN](https://www.ntrand.com/jp/ntbetamean/)
  - 標準偏差計算 : [NTBETASTDEV](https://www.ntrand.com/jp/ntbetaskew/)
  - 歪度計算 : [NTBETASKEW](https://www.ntrand.com/jp/ntbetaskew/)
  - 尖度計算 : [NTBETAKURT](https://www.ntrand.com/jp/ntbetakurt/)
  - 上記の各モーメントを一度に計算 : [NTBETAMOM](https://www.ntrand.com/jp/ntbetamom/)
- 分布の平均と標準偏差をお持ちの場合
  - 分布のパラメータ推定 : [NTBETAPARAM](https://www.ntrand.com/jp/ntbetaparam/)
