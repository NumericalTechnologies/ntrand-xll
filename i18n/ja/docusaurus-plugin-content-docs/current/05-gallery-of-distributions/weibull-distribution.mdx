...
- 2つのパラメータ $\alpha, \beta$ が必要です ([どうやって求めるの？](https://www.ntrand.com/jp/ntweibullparam/))。
...
- 関連 NtRand 関数 : [NTWEIBULLDIST](https://www.ntrand.com/jp/ntweibulldist/)
...
- 関連 NtRand 関数 : [NTWEIBULLINV](https://www.ntrand.com/jp/ntweibullinv/)
...
- 分布の[平均](https://www.ntrand.com/jp/glossary/#local_mean) は次式で与えられます。
  ...
  ここで、$\Gamma(\cdot)$ は [ガンマ関数](https://www.ntrand.com/jp/glossary/#local_Gamma)です。
...
- 関連 NtRand 関数 : [NTWEIBULLMEAN](https://www.ntrand.com/jp/ntweibullmean/)
...
- 分布の[分散](https://www.ntrand.com/jp/glossary/#local_variance) は次式で与えられます。
  ...
  、 $\Gamma(\cdot)$ は [ガンマ関数](https://www.ntrand.com/jp/glossary/#local_Gamma)、$m$は分布の[平均](https://www.ntrand.com/jp/glossary/#local_mean)です。
...
- 関連 NtRand 関数 : [NTWEIBULLSTDEV](https://www.ntrand.com/jp/ntweibullstdev/)
...
- 分布の[歪度](https://www.ntrand.com/jp/glossary/#local_skew) は次式で与えられます。
  ...
  、$\Gamma(\cdot)$ は [ガンマ関数](https://www.ntrand.com/jp/glossary/#local_Gamma)、$m$は分布の[平均](https://www.ntrand.com/jp/glossary/#local_mean)、$\sigma$ は 分布の[標準偏差](https://www.ntrand.com/jp/glossary/#local_standard_deviation)です。
...
- 関連 NtRand 関数 : [NTWEIBULLSKEW](https://www.ntrand.com/jp/ntweibullskew/)
...
- 分布の[尖度](https://www.ntrand.com/jp/glossary/#local_kurtosis) は次式で与えられます。
  ...
  、$\Gamma(\cdot)$ は [ガンマ関数](https://www.ntrand.com/jp/glossary/#local_Gamma)、$m$ は分布の[平均](https://www.ntrand.com/jp/glossary/#local_mean)、$\sigma$ は分布の[標準偏差](https://www.ntrand.com/jp/glossary/#local_standard_deviation)、$\gamma_1$ は分布の[歪度](https://www.ntrand.com/jp/glossary/#local_skewness)です。
...
- 関連 NtRand 関数 : [NTWEIBULLKURT](https://www.ntrand.com/jp/ntweibullkurt/)
...
- 既に分布のパラメータをお持ちの場合
  - Mersenne Twiseter 法による乱数生成 : [NTRANDWEIBULL](https://www.ntrand.com/jp/ntrandweibull/)
  - 確率計算 : [NTWEIBULLDIST](https://www.ntrand.com/jp/ntweibulldist/)
  - 平均計算 : [NTWEIBULLMEAN](https://www.ntrand.com/jp/ntweibullmean/)
  - 標準偏差計算 : [NTWEIBULLSTDEV](https://www.ntrand.com/jp/ntweibullskew/)
  - 歪度計算 : [NTWEIBULLSKEW](https://www.ntrand.com/jp/ntweibullskew/)
  - 尖度計算 : [NTWEIBULLKURT](https://www.ntrand.com/jp/ntweibullkurt/)
  - 上記の各モーメントを一度に計算 : [NTWEIBULLMOM](https://www.ntrand.com/jp/ntweibullmom/)
- 分布の平均と標準偏差をお持ちの場合
  - 分布のパラメータ推定 : [NTWEIBULLPARAM](https://www.ntrand.com/jp/ntweibullparam/)
