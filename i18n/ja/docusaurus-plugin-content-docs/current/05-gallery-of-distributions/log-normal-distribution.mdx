...
最近では、対数収益率は正規分布よりもっと裾の厚い分布に従っているという議論が高まってきています。そういった分布として[ジョンソン SU 分布](https://www.ntrand.com/jp/johnson-su-distribution/)が現在非常に注目されているのです。
...
正規分布の[累積分布関数](https://www.ntrand.com/jp/glossary/#local_Cumulative)は
...
になります。そう、[正規分布](https://www.ntrand.com/jp/normal-distribution-single/)の変数を $x\rightarrow \log x$ としただけなんです。\
ここでもうちょっと**注意**。 [正規分布](https://www.ntrand.com/jp/normal-distribution-single/)の[確率密度関数](https://www.ntrand.com/jp/glossary/#local_Probability)が

$$
\frac{1}{\sigma}\phi\left(\frac{x-m}{\sigma}\right)
$$

であるからって、調子に乗って対数正規分布の[確率密度関数](https://www.ntrand.com/jp/glossary/#local_Probability)を、

$$
f(x)=\frac{1}{\sigma}\phi\left(\frac{\log x-m}{\sigma}\right)
$$

としないようにしましょう。[確率密度関数](https://www.ntrand.com/jp/glossary/#local_Probability)は、[累積分布関数](https://www.ntrand.com/jp/glossary/#local_Cumulative)を微分して求めるもの。だから正しい[確率密度関数](https://www.ntrand.com/jp/glossary/#local_Probability)は、
...
- 2つのパラメータ $M, S$ が必要です ([どうやって求めるの？](https://www.ntrand.com/jp/ntlognormparam/)).
...
- 関連 NtRand 関数 : [NTLOGNORMDIST](https://www.ntrand.com/jp/ntlognormdist/)
...
- 関連 NtRand 関数 : [NTLOGNORMINV](https://www.ntrand.com/jp/ntlognorminv/)
...
- 関連 NtRand 関数 : [NTLOGNORMMEAN](https://www.ntrand.com/jp/ntlognormmean/)
...
- 関連 NtRand 関数 : [NTLOGNORMSTDEV](https://www.ntrand.com/jp/ntlognormstdev/)
...
- 関連 NtRand 関数 : [NTLOGNORMSKEW](https://www.ntrand.com/jp/ntlognormskew/)
...
- 関連 NtRand 関数 : [NTLOGNORMKURT](https://www.ntrand.com/jp/ntlognormkurt/)
...
- 関連 NtRand 関数 : [NTRANDLOGNORM](https://www.ntrand.com/jp/ntrandlognorm/)
...
- 既に分布のパラメータをお持ちの場合
  - Mersenne Twiseter 法による乱数生成 : [NTRANDLOGNORM](https://www.ntrand.com/jp/ntrandlognorm/)
  - 確率計算 : [NTLOGNORMDIST](https://www.ntrand.com/jp/ntlognormdist/)
  - 平均計算 : [NTLOGNORMMEAN](https://www.ntrand.com/jp/ntlognormmean/)
  - 標準偏差計算 : [NTLOGNORMSTDEV](https://www.ntrand.com/jp/ntlognormskew/)
  - 歪度計算 : [NTLOGNORMSKEW](https://www.ntrand.com/jp/ntlognormskew/)
  - 尖度計算 : [NTLOGNORMKURT](https://www.ntrand.com/jp/ntlognormkurt/)
  - 上記の各モーメントを一度に計算 : [NTLOGNORMMOM](https://www.ntrand.com/jp/ntlognormmom/)
- 分布の平均と標準偏差をお持ちの場合
  - 分布のパラメータ推定 : [NTLOGNORMPARAM](https://www.ntrand.com/jp/ntlognormparam/)
