...
[標準正規分布](https://www.ntrand.com/jp/normal-distribution-single/)に従う疑似乱数を返します。乱数は超長周期 (2^19937^-1)、 かつ高次元均等性（623次元）を備えた[Mersenne Twister アルゴリズム](https://www.ntrand.com/jp/glossary/#local_Mersenne_Twister) を基に生成されます。
...
- 逆関数法を用いる場合、[累積分布関数](https://www.ntrand.com/jp/glossary/#local_Cumulative)の逆関数は[Moro の方法](https://www.ntrand.com/jp/glossary/#local_Inversefunctionmethod)を用いて近似しています。
