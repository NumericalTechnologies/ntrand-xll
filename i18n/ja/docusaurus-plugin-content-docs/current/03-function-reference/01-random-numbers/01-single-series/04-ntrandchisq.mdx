...
[カイ2乗分布](https://www.ntrand.com/jp/chi-square-distribution/)に従う疑似乱数を返します。乱数は超長周期 (2^19937^-1)、 かつ高次元均等性（623次元）を備えた[Mersenne Twister アルゴリズム](https://www.ntrand.com/jp/glossary/#local_Mersenne_Twister) を基に生成されます。
