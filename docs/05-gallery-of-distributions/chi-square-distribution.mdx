...
- Function reference : [NTCHISQDIST](https://www.ntrand.com/ntchisqdist/)
...
- Function reference : [NTCHISQMEAN](https://www.ntrand.com/ntchisqmean/)
...
- Function reference : [NTCHISQSTDEV](https://www.ntrand.com/ntchisqstdev/)
...
- Function reference : [NTCHISQSKEW](https://www.ntrand.com/ntchisqskew/)
...
- Function reference : [NTCHISQKURT](https://www.ntrand.com/ntchisqkurt/)
...
- Function reference : [NTRANDCHISQ](https://www.ntrand.com/ntrandchisq/)

## NtRand Functions

- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDCHISQ](https://www.ntrand.com/ntrandchisq/)
  - Computing probability : [NTCHISQDIST](https://www.ntrand.com/ntchisqdist/)
  - Computing mean : [NTCHISQMEAN](https://www.ntrand.com/ntchisqmean/)
  - Computing standard deviation : [NTCHISQSTDEV](https://www.ntrand.com/ntchisqskew/)
  - Computing skewness : [NTCHISQSKEW](https://www.ntrand.com/ntchisqskew/)
  - Computing kurtosis : [NTCHISQKURT](https://www.ntrand.com/ntchisqkurt/)
  - Computing moments above at once : [NTCHISQMOM](https://www.ntrand.com/ntchisqmom/)
