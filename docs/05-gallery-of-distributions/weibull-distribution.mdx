...
- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDWEIBULL](../03-function-reference/01-random-numbers/01-single-series/16-ntrandweibull.mdx)
