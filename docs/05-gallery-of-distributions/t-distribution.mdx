...
- [Cumulative distribution function](https://www.ntrand.com/glossary/#local_cumulative)
  ...
  , where $\gamma=\frac{N}{N+x^2}$ and $I_{x}(\cdot,\cdot)$ is [regularized incomplete beta function](https://www.ntrand.com/glossary/#local_regularized_incomplete_beta).
...
- Function reference : [NTTDIST](https://www.ntrand.com/nttdist/)

## Characteristics

### Mean -- Where is the "center" of the distribution? ([Definition](https://www.ntrand.com/glossary/#local_mean))

- [Mean](https://www.ntrand.com/glossary/#local_mean) of the distribution is defined for $N>1$ and is always 0.
...
- Function reference : [NTTMEAN](https://www.ntrand.com/nttmean/)
...
- Function reference : [NTTSTDEV](https://www.ntrand.com/nttstdev/)
...
- Function reference : [NTTSKEW](https://www.ntrand.com/nttskew/)
...
- Function reference : [NTTKURT](https://www.ntrand.com/nttkurt/)
...
- Function reference : [NTRANDT](https://www.ntrand.com/ntrandt/)

## NtRand Functions

- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDT](https://www.ntrand.com/ntrandt/)
  - Computing probability : [NTTDIST](https://www.ntrand.com/nttdist/)
  - Computing mean : [NTTMEAN](https://www.ntrand.com/nttmean/)
  - Computing standard deviation : [NTTSTDEV](https://www.ntrand.com/nttskew/)
  - Computing skewness : [NTTSKEW](https://www.ntrand.com/nttskew/)
  - Computing kurtosis : [NTTKURT](https://www.ntrand.com/nttkurt/)
  - Computing moments above at once : [NTTMOM](https://www.ntrand.com/nttmom/)
