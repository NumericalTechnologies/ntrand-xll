...
- [Skewness](https://www.ntrand.com/glossary/#local_skew) of the distribution is defined for $N>3$$ and is always 0.
...
- Function reference : [NTRANDT](../03-function-reference/01-random-numbers/01-single-series/12-ntrandt.mdx)

## NtRand Functions

- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDT](../03-function-reference/01-random-numbers/01-single-series/12-ntrandt.mdx)
