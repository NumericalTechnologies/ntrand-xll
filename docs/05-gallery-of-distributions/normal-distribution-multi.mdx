...
- [NTBINROMDIST](https://www.ntrand.com/ntbinormdist/) is singular, when correlation coefficient $\rho=\pm 1$ and x1=x2.
...
- Function reference : [NTBINORMDIST](https://www.ntrand.com/ntbinormdist/)
...
- Generating random numbers based on Mersenne Twister algorithm: [NTRANDMULTINORM](https://www.ntrand.com/ntrandmultinorm/)
- Computing probability for 2-variables : [NTBINORMDIST](https://www.ntrand.com/ntbinormdist/)
