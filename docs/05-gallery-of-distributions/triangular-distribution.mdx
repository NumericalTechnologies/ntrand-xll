...
- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDTRIANGULAR](../03-function-reference/01-random-numbers/01-single-series/14-ntrandtriangular.mdx)
