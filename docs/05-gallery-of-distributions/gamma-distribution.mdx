...
- Two parameters $\alpha, \beta$ are required ([How can you get these?](https://www.ntrand.com/ntgammaparam/))
...
- Function reference : [NTGAMMADIST](https://www.ntrand.com/ntgammadist/)
...
- Function reference : [NTGAMMAMEAN](https://www.ntrand.com/ntgammamean/)
...
- Function reference : [NTGAMMASTDEV](https://www.ntrand.com/ntgammastdev/)
...
- Function reference : [NTGAMMASKEW](https://www.ntrand.com/ntgammaskew/)
...
- Function reference : [NTGAMMAKURT](https://www.ntrand.com/ntgammakurt/)
...
- Function reference : [NTRANDGAMMA](https://www.ntrand.com/ntrandgamma/)

## NtRand Functions

- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDGAMMA](https://www.ntrand.com/ntrandbeta/)
  - Computing probability : [NTGAMMADIST](https://www.ntrand.com/ntgammadist/)
  - Computing mean : [NTGAMMAMEAN](https://www.ntrand.com/ntgammamean/)
  - Computing standard deviation : [NTGAMMASTDEV](https://www.ntrand.com/ntgammaskew/)
  - Computing skewness : [NTGAMMASKEW](https://www.ntrand.com/ntgammaskew/)
  - Computing kurtosis : [NTGAMMAKURT](https://www.ntrand.com/ntgammakurt/)
  - Computing moments above at once : [NTGAMMAMOM](https://www.ntrand.com/ntgammamom/)
- If you know mean and standard deviation of the distribution
  - Estimating parameters of the distribution:[NTGAMMAPARAM](https://www.ntrand.com/ntgammaparam/)
