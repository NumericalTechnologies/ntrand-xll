...
- Function reference : [NTTRUNCNORMSTDEV](../03-function-reference/02-distribution-functions/102-nttruncnormstdev.mdx)
...
- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDTRUNCNORM](../03-function-reference/01-random-numbers/01-single-series/15-ntrandtruncnorm.mdx)
