...
- If you already have parameters of the distribution
  - Generating random numbers based on Mersenne Twister algorithm: [NTRANDPOISSON](../03-function-reference/01-random-numbers/01-single-series/11-ntrandpoisson.mdx)
