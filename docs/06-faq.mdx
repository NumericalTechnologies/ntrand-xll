...
Sample sheets can be downloaded from [Download](https://www.ntrand.com/download/) page. **After [installing](https://www.ntrand.com/install/) NtRand excel add-in**, open the sample sheet to understand how to use NtRand functions.\
...
You can also check details at [Sample Sheet](https://www.ntrand.com/files/NtRand1.zip).
...
You can also check details at [sample (Truncated Weibull distribution)](https://www.ntrand.com/files/TruncatedWeibullRandom.zip)
