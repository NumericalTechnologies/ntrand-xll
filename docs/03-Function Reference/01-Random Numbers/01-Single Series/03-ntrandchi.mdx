...
Returns chi pseudo random number(s) based on [Mersenne Twister Algorithm](https://www.ntrand.com/glossary/#local_Mersenne_Twister) which has long period ($2^{19937}-1$), high order of equidistribution and 623 dimensions.
